...
public class TextureToPolygonFromScratch implements GLEventListener{
	File file;
	Texture texture;
    /**
    ...
    public static void main(String[] args) {
        ...
        TextureToPolygonFromScratch cube = new TextureToPolygonFromScratch();
     ...
     */
    public TextureToPolygonFromScratch() {
    	    }
    ...
    public void init(GLAutoDrawable drawable) {
      ...
      //  gl2.glBlendFunc(GL2.GL_SRC_ALPHA, GL2.GL_ONE_MINUS_SRC_ALPHA);
        ...
        gl2.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGBA, 100, 100, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, buffer);
